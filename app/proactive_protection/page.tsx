  ...
  return (
    <>
      ...
      <main className={`flex-1 my-14 container max-w-[1300px] mx-auto ${isFormQuestion || isCheckPass || isFormFreeLicense && "max-md:hidden"}`}>
        ...
        <section className="bg-bg-custom_gray p-[60px] max-md:p-10 mt-20 rounded-[48px] max-sm:px-5">
          <div className=" ">
            {/* Заголовок */}
              ...
              <table className="w-[1180px]  max-md:w-[664px] border-collapse bg-white rounded-lg">
                ...
                <thead>
                  <tr className="bg-bg-custom_gray border-[#000000] border-opacity-[0.1] border-b bg-bg-custom_gray">
                    <th className="py-4 text-left text-lg max-lg:text-lg bg-bg-custom_gray font-semibold leading-[140%]">
                      Функциональность
                    </th>
                    <th className="py-4 px-6 font-semibold text-lg max-lg:text-lg leading-[140%] text-center bg-bg-custom_green  rounded-se-3xl rounded-ss-3xl text-white">
                      Strongpass
                    </th>
                    <th className="py-4 px-6 font-semibold text-lg max-lg:text-lg leading-[140%] text-center bg-bg-custom_gray">
                ...
                <tbody>
                  ...
                  <tr className="bg-bg-custom_gray">
                    <td className="py-[0.5rem] text-lg max-lg:text-base font-normal leading-[160%] max-md:max-w-[264px] max-md:pr-5 bg-bg-custom_gray max-w-[680px] inline-block">
