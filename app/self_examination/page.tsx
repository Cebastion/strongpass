        ...
        <section className="max-w-[1180px] mx-auto mt-20 max-[1180px]:px-5 max-md:p-0">
          <div className="w-full grid grid-cols-4 gap-x-5 gap-y-10 max-[1150px]:grid-cols-2">
            <div className="w-[280px] h-[155px] flex flex-col gap-5 max-[1150px]:mx-auto max-sm:w-[150px] max-sm:h-[224px] max-sm:items-center">
              ...
              >
                <path
                  d="M25.9023 8.32031L21.1211 21.75H28.7852C30.0039 21.8438 30.6602 22.4766 30.7539 23.6484C30.7539 24.2109 30.543 24.6797 30.1211 25.0547L11.418 41.5781C11.0898 41.8594 10.7148 42 10.293 42C9.63672 41.9531 9.14453 41.6953 8.81641 41.2266C8.48828 40.7578 8.41797 40.2422 8.60547 39.6797L13.3867 26.25H5.58203C4.45703 26.1562 3.84766 25.5469 3.75391 24.4219C3.75391 23.9062 3.96484 23.4609 4.38672 23.0859L23.0898 6.42188C23.418 6.14062 23.793 6 24.2148 6C24.8711 6.04688 25.3633 6.30469 25.6914 6.77344C26.0195 7.24219 26.0898 7.75781 25.9023 8.32031ZM15.0039 24C15.3789 24 15.6836 24.1641 15.918 24.4922C16.1523 24.8203 16.1992 25.1484 16.0586 25.4766L11.418 38.625L27.9414 24H19.5039C19.1289 24 18.8242 23.8359 18.5898 23.5078C18.3555 23.1797 18.3086 22.8516 18.4492 22.5234L23.0898 9.44531L6.70703 24H15.0039ZM36.3789 26.25C36.8477 26.25 37.1758 26.4609 37.3633 26.8828L44.1133 40.3828C44.3945 41.0391 44.2305 41.5312 43.6211 41.8594C42.9648 42.1406 42.4727 41.9766 42.1445 41.3672L40.7383 38.625H32.0195L30.6133 41.3672C30.2852 41.9766 29.793 42.1406 29.1367 41.8594C28.5273 41.5312 28.3633 41.0391 28.6445 40.3828L35.3945 26.8828C35.582 26.4609 35.9102 26.25 36.3789 26.25ZM33.1445 36.375H39.6133L36.3789 29.9062L33.1445 36.375Z"
                  fill="#408077"
                />
              </svg>
