...
const page = (props: Props) => {
  ...
  const Spoiler = () => {
    return (
      <div className="absolute hidden group-hover:block p-5 rounded-2xl shadow-lg bg-white w-[532px] -top-[25rem] -right-[16.9rem] max-md:-right-[31rem] max-[535px]:w-[300px]">
