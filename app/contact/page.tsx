    ...
    <>
      ...
      >
        ...
        <form
          ...
          className="p-9 flex flex-col gap-y-5 max-lg:gap-[8px] mx-auto max-lg:m-0 rounded-[48px] max-sm:p-4 max-sm:rounded-3xl bg-white w-[580px] max-lg:mx-auto max-lg:w-full max-lg:h-h-auto"
        >
          <input
            required
            type="text"
