...
const From = () => {
  ...
  return (
    <section id="form" className="mt-[120px] h-[682px] max-lg:h-auto bg-bg-custom_green rounded-[48px] max-sm:rounded-3xl p-10 max-lg:py-10 max-lg:px-5 flex justify-between max-lg:flex-col">
      ...
      className="p-9 flex flex-col gap-[8px] max-lg:gap-[8px] mx-5 my-6 max-lg:m-0 rounded-[36px] max-sm:p-4 max-sm:rounded-3xl bg-white w-[580px] h-[562px] max-lg:mx-auto max-lg:w-full max-lg:h-h-auto"
    >
      <input
      required
        type="text"
